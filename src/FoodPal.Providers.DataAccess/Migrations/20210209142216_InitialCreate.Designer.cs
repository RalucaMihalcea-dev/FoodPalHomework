...
namespace FoodPal.Providers.DataAccess.Migrations
{
    ...
    [Migration("20210209142216_InitialCreate")]
            ...
            modelBuilder.Entity("FoodPal.Providers.DomainModels.CatalogueItemCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 515, DateTimeKind.Local).AddTicks(1254),
                            Name = "Dessert"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 515, DateTimeKind.Local).AddTicks(1988),
                            Name = "Main Course"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 515, DateTimeKind.Local).AddTicks(2000),
                            Name = "Soups"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 515, DateTimeKind.Local).AddTicks(2004),
                            Name = "Apperitives"
                        });
                });
            ...
            modelBuilder.Entity("FoodPal.Providers.DomainModels.ProviderCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 505, DateTimeKind.Local).AddTicks(3679),
                            Name = "Mediteranean Cousine"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 513, DateTimeKind.Local).AddTicks(4137),
                            Name = "Tradinional Romanian Cousine"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 513, DateTimeKind.Local).AddTicks(4218),
                            Name = "Japonese Cousine"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2021, 2, 9, 16, 22, 13, 513, DateTimeKind.Local).AddTicks(4226),
                            Name = "Thai Cousine"
                        });
                });
